...
public class TPS2TamfUI extends CoreUI implements IDragProcessor, IProgress
{
	...
	public void processDrop(List<File> files) 
	{
		...
		findTpses(sb, (File[])files.toArray());
		txtAreaFiles.setText(sb.toString());
	}
	
	private void findTpses(StringBuilder sb, File[] files)
	{
	...
	private void initCtrls()
	{
		...
		msgDes.append("* 拖动一个或多个tps文件或包含tps的目录到文本框内.<br>");
		msgDes.append("* 只处理maps里面的内容.<br>");
