...
public class LzmaAlone
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		if (params.Command == CommandLine.kBenchmak)
		{
			...
			e1.tools.lzma.sevenzip.LzmaBench.LzmaBenchmark(params.NumBenchmarkPasses, dictionary);
		}
		else if (params.Command == CommandLine.kEncode || params.Command == CommandLine.kDecode)
		{
			...
			{
				e1.tools.lzma.sevenzip.compression.lzma.Encoder encoder = new e1.tools.lzma.sevenzip.compression.lzma.Encoder();
			...
			else
			{
				...
				e1.tools.lzma.sevenzip.compression.lzma.Decoder decoder = new e1.tools.lzma.sevenzip.compression.lzma.Decoder();
