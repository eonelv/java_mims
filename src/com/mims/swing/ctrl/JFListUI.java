...
import com.mims.swing.ctrl.JFDragRecognitionSupport.BeforeDrag;
 ...
 * 
 */
public class JFListUI extends BasicListUI
{
    ...
    protected JFList list = null;
    protected JFCellRendererPane rendererPane;
	...
	if (c.getComponentOrientation().isLeftToRight()) {
        ...
        for (int colCounter = startColumn; colCounter <= endColumn;
             ...
             * 绘制每行的控件
             */
//            rowBounds.x = rowBounds.x + 1;
//            rowBounds.width = rowBounds.width - 2;
            if (rowBounds == null) {
                return;
            }
...
//        	g.setColor(Color.RED);
	...
	SwingUtilities.replaceUIInputMap(list, JComponent.WHEN_FOCUSED,
        ...
        LazyActionMap.installLazyActionMap(list, JFListUI.class,
                                           "List.actionMap");
    }
...
//        LookAndFeel.installBorder(list, "List.border");
    ...
    public void installUI(JComponent c)
    {
        ...
        rendererPane = new JFCellRendererPane();
        list.add(rendererPane);
        list.setCellRenderer(new JFListCellRenderer());
        //TODO 设置List的Border 
//        list.setBorder(new JFBorders.TextFieldBorder());
        ...
        c.setBackground(SwingConst.PANEL_BACKGROUND);
    }
    ...
    private static class Actions extends UIAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            JFListUI ui = (JFListUI)JFLookAndFeel.getUIOfType(
	...
	private int getNextColumnIndex(JList list, JFListUI ui,
                                       int amount) {
	...
	private int getNextIndex(JList list, JFListUI ui, int amount) {
            int index = adjustIndex(list.getLeadSelectionIndex(), list);
	    int size = list.getModel().getSize();
	...
	private boolean isNavigationKey(KeyEvent event) {
        ...
        public void mousePressed(MouseEvent e) {
            ...
            if (dragEnabled) {
                ...
                if (row != -1 && JFDragRecognitionSupport.mousePressed(e)) {
        ...
        public void mouseDragged(MouseEvent e) {
            ...
            if (list.getDragEnabled()) {
            	JFDragRecognitionSupport.mouseDragged(e, this);
                return;
            }
        ...
        public void mouseReleased(MouseEvent e) {
            ...
            if (list.getDragEnabled()) {
                MouseEvent me = JFDragRecognitionSupport.mouseReleased(e);
                if (me != null) {
                    SwingUtilities2.adjustFocus(list);
	 ...
	 */
		...
		Object[] values = list.getSelectedValues();
                ...
                return new JFBasicTransferable(plainBuf.toString(), htmlBuf.toString());
	    }
