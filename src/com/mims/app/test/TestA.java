...
//		scrollPane.setHorizontalScrollBar(new JFScrollBar(Adjustable.HORIZONTAL));
	...
	private void initActions(){
		...
		comboSysColor.addDataChangeListener(new DataChangeListener()
		{
			
			public void dataChanged(DataChangeEvent event)
			{
				txtName.setText((String)event.getNewValue());
			}
		});
...
//						"...........................................D.............................D");
		...
		datePicker.addDataChangeListener(new DataChangeListener()
		{
			
			public void dataChanged(DataChangeEvent event)
			{
				txtNumber.setText(event.getNewValue().toString());
			}
		});
	}
}
